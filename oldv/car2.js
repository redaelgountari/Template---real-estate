  ...
  function initGlobalAnimations() {
      ...
      if (plugins.ScrollTrigger) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 50, rotateX: 90 },
          {
            ...
            stagger: 0.1,
            ease: 'power2.out',
            scrollTrigger: { trigger: title, start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      }
    });
      ...
      if (exists('.location-title')) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 30 },
          {
            ...
            duration: 1,
            ease: 'power2.out',
            scrollTrigger: { trigger: '.location-title', start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      }
      if (exists('.location-subtitle')) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 20 },
          {
            ...
            delay: 0.3,
            ease: 'power2.out',
            scrollTrigger: { trigger: '.location-subtitle', start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      }
      if (exists('.location-divider')) {
        gsap.fromTo(
          ...
          { opacity: 0, scaleX: 0 },
          {
            ...
            delay: 0.5,
            ease: 'power2.out',
            scrollTrigger: { trigger: '.location-divider', start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      }
    }
    ...
    $$('.section-divider').forEach((divider) => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: { trigger: divider, start: 'top 85%', toggleActions: 'play none none ' },
      });
      ...
      $$('.section-subtitle').forEach((subtitle) => {
        gsap.fromTo(
          ...
          { opacity: 0, y: 30 },
          {
            ...
            duration: 1,
            ease: 'power2.out',
            scrollTrigger: { trigger: subtitle, start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      });
    }
    ...
    if (plugins.ScrollTrigger && exists('.about-image')) {
      gsap.fromTo(
        ...
        { opacity: 0, y: 50, rotation: -5 },
        {
          ...
          duration: 1.5,
          ease: 'power2.out',
          scrollTrigger: { trigger: '.about-image', start: 'top 85%', toggleActions: 'play none none ' },
        }
      );
    }
      ...
      if (plugins.ScrollTrigger) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 80, scale: 0.9, rotation: -5 },
          {
            ...
            ease: 'back.out(1.7)',
            delay: index * 0.15,
            scrollTrigger: { trigger: item, start: 'top 85%', toggleActions: 'play none none' },
          }
        );
      }
      ...
      if (exists('.main-arch-image')) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 80, rotateX: 45 },
          {
            ...
            duration: 1.5,
            ease: 'power2.out',
            scrollTrigger: { trigger: '.main-arch-image', start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      }
      if (exists('.secondary-arch-image')) {
        gsap.fromTo(
          ...
          { opacity: 0, x: 80, rotateY: -45 },
          {
            ...
            ease: 'back.out(1.7)',
            delay: 0.3,
            scrollTrigger: { trigger: '.secondary-arch-image', start: 'top 85%', toggleActions: 'play none none' },
          }
        );
      }
      if (exists('.tertiary-arch-image')) {
        gsap.fromTo(
          ...
          { opacity: 0, x: -80, rotateY: 45 },
          {
            ...
            ease: 'back.out(1.7)',
            delay: 0.6,
            scrollTrigger: { trigger: '.tertiary-arch-image', start: 'top 85%', toggleActions: 'play none none' },
          }
        );
      }
    }
      ...
      $$('.info-bubble').forEach((bubble, index) => {
        gsap.fromTo(
          ...
          { opacity: 0, y: 30, scale: 0.5 },
          {
            ...
            ease: 'back.out(2)',
            delay: index * 0.3 + 1,
            scrollTrigger: { trigger: bubble, start: 'top 85%', toggleActions: 'play none none ' },
          }
        );
      });
    }
    ...
    if (plugins.ScrollTrigger && exists('.luxury-form-container')) {
      gsap.fromTo(
        ...
        { opacity: 0, y: 80, scale: 0.9 },
        {
          ...
          duration: 1.5,
          ease: 'power2.out',
          scrollTrigger: { trigger: '.luxury-form-container', start: 'top 85%', toggleActions: 'play none none ' },
        }
      );
    }
